...
import com.joanes.demoparkapi.service.UsuarioService;
...
import com.joanes.demoparkapi.web.dto.mapper.ClienteMapper;
...
public class ClienteController {
    ...
    public ResponseEntity<PageableDto> getAll(@Parameter(hidden = true) @PageableDefault(size = 5, sort = {"nome"}) Pageable pageable) {
        Page<ClienteProjection> clientes;
        clientes = clienteService.buscarTodos(pageable);
